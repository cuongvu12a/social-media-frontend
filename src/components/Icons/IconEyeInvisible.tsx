...
export const IconEyeInvisible = (props: any) => {
  return <Icon component={IconEyeInvisibleSvg} {...props} />;
};

const IconEyeInvisibleSvg = () => (
  <svg
    className='w-full'
    viewBox='0 0 24 24'
    fill='currentColor'
